...
class OurDQN(OffPolicyRLModel):
    ...
    """
    def __init__(self, policy, env, gamma=0.99, learning_rate=5e-4, buffer_size=50000, exploration_fraction=0.2,
                 exploration_final_eps=0.01, exploration_initial_eps=0.6, train_freq=1, batch_size=32, double_q=True,
