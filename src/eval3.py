...
# plt.ylim([-100, 150])
plt.legend()
plt.savefig('./results/chasing_prey/ALL_learning_rewardsperepisode.png')
plt.clf()
...
plt.ylabel('Accumulated reward')
plt.legend()
plt.savefig('./results/chasing_prey/learning_totalrewards.png')
plt.clf()
...
plt.legend()
plt.savefig('./results/chasing_prey/learning_timessperepisode.png')
plt.clf()
...
plt.legend()
plt.savefig('./results/chasing_prey/learning_totaltime.png')
plt.clf()
